...
public class ProductsServiceTests
{
    ...
    private readonly ProductsService.Business.Services.ProductsService _productsService;
    ...
    public ProductsServiceTests()
    {
        ...
        _productsService = new ProductsService.Business.Services.ProductsService(
